...
Her tester vi matte - u.brøk $\bar{x} = \sum_{i=1}^{N} x_i/N$

Her tester vi matte - brøk $\bar{x} = \frac{\sum_{i=1}^{N} x_i}{N}$

Display (Eige avsnitt) - U.brøk: $$\bar{x} = \sum_{i=1}^{N} x_i/N$$

Display (Eige avsnitt) - Brøk: $$\bar{x} = \frac{\sum_{i=1}^{N} x_i}{N}$$
